...
ADD TARGET package0.event_file(SET
        ...
        filename=N'E:\Разработка\Мокроусов\РасширенныеСобытийSQL\Взаимоблокировки\DeadlockAnalyze.xel',
        -- Максимальный размер файла в мегабайтах
        max_file_size=(10),
        -- Максимальное количество файлов, после чего начнется перезапись логов в более старых файлах.
        max_rollover_files=(5),
        metadatafile=N'E:\Разработка\Мокроусов\РасширенныеСобытийSQL\Взаимоблокировки\DeadlockAnalyze.xem'
    )
WITH (
        MAX_MEMORY=4096 KB,
